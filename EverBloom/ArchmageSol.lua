local mod	= DBM:NewMod(1208, "VEM-Party-WoD", 5, 556)
...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif spellId == 166726 self:AntiSpam(10, args.destName) then--Because dumb spell has no cast Id, we can only warn when people get debuff from standing in it.
